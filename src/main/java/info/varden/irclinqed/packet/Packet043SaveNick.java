...
public class Packet043SaveNick extends NumericResponsePacket {
	public Packet043SaveNick(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.SERVER_ERROR, "Forced nickname change (" + getMessage() + ")");
	}
}
