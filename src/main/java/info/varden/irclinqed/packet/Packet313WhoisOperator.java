...
public class Packet313WhoisOperator extends NumericResponsePacket {
	public Packet313WhoisOperator(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.SERVER_INFO, thread.getNetworkName(), getParam(1) + " " + getMessage());
	}
}
