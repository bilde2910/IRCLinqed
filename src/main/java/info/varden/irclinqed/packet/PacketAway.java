...
public class PacketAway extends IRCPacket {
	public PacketAway(IRCLinqed il, IRCThread thread, String command) {
	...
	public boolean send() {
		if (this.command.length() >= 1) {
			return thread.sendRaw(this, "AWAY :" + this.command);
		} else {
			return thread.sendRaw(this, "AWAY");
		}
	}
