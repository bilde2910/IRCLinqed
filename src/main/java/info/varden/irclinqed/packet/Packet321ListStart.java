...
public class Packet321ListStart extends NumericResponsePacket {
	public Packet321ListStart(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.SERVER_INFO, "Downloading channel list...");
	}
}
