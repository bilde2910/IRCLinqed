...
public class PacketWhois extends IRCPacket {
	public PacketWhois(IRCLinqed il, IRCThread thread, String command) {
	...
	@Override
	public boolean send() {
		return thread.sendRaw(this, "WHOIS " + this.command);
	}
