...
public class Packet409NoOrigin extends NumericResponsePacket {
	public Packet409NoOrigin(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.LQS_BUG, "ERR_NOORIGIN (409) received.");
	}
}
