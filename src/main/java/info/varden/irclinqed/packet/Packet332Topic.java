...
public class Packet332Topic extends NumericResponsePacket {
	public Packet332Topic(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.IRC_CHANNOTICE, getParam(1), "Topic for " + getParam(1) + " is " + getMessage());
	}
}
