...
public class Packet331NoTopic extends NumericResponsePacket {
	public Packet331NoTopic(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.IRC_CHANNOTICE, getParam(1), "No topic set for " + getParam(1));
	}
}
