...
public class Packet391Time extends NumericResponsePacket {
	public Packet391Time(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.SERVER_INFO, this.thread.getNetworkName(), "Server time is " + getMessage());
	}
}
