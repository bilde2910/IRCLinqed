...
public class Packet382Rehashing extends NumericResponsePacket {
	public Packet382Rehashing(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		writeRawReplyToChatWithFirstParam(MessageType.SERVER_INFO, this.thread.getNetworkName());
	}
}
