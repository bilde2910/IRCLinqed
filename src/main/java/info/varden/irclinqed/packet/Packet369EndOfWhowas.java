...
public class Packet369EndOfWhowas extends NumericResponsePacket {
	public Packet369EndOfWhowas(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		writeRawReplyToChat(MessageType.SERVER_INFO, thread.getNetworkName());
	}
}
