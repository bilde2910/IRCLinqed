...
public class Packet351Version extends NumericResponsePacket {
	public Packet351Version(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.SERVER_INFO, "Server is running " + getParam(2) + " " + getParam(1) + " (" + getMessage() + ")");
	}
}
