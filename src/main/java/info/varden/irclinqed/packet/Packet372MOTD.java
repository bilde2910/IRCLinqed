...
public class Packet372MOTD extends NumericResponsePacket {
	public Packet372MOTD(IRCLinqed il, IRCThread thread, String command) {
	...
	public void handle() {
		if (getBooleanKey("showmotd")) {
			writeRawReplyToChat(MessageType.SERVER_MOTD, this.thread.getNetworkName());
		}
	}
}
