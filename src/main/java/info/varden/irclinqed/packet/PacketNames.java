...
public class PacketNames extends IRCPacket {
	public PacketNames(IRCLinqed il, IRCThread thread, String command) {
	...
	@Override
	public boolean send() {
		return thread.sendRaw(this, "NAMES " + this.command);
	}
