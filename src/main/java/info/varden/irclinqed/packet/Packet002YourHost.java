...
public class Packet002YourHost extends NumericResponsePacket {
	public Packet002YourHost(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		writeRawReplyToChat(MessageType.SERVER_INFO);
	}
}
