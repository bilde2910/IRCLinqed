...
public class Packet502UsersDontMatch extends NumericResponsePacket {
	public Packet502UsersDontMatch(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		writeRawReplyToChat(MessageType.SERVER_ERROR);
	}
}
