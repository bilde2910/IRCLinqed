...
public class Packet341Inviting extends NumericResponsePacket {
	public Packet341Inviting(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.IRC_CHANNOTICE, getParam(1), "Inviting " + getParam(2) + " to channel");
	}
}
