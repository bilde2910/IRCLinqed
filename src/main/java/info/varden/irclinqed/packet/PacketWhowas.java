...
public class PacketWhowas extends IRCPacket {
	public PacketWhowas(IRCLinqed il, IRCThread thread, String command) {
	...
	@Override
	public boolean send() {
		return thread.sendRaw(this, "WHOWAS " + this.command);
	}
