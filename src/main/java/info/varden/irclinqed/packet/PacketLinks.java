...
public class PacketLinks extends IRCPacket {
	public PacketLinks(IRCLinqed il, IRCThread thread, String command) {
	...
	@Override
	public boolean send() {
		return thread.sendRaw(this, "LINKS" + ("".equals(this.command) ? "" : " ") + this.command);
	}
