...
public class Packet342Summoning extends NumericResponsePacket {
	public Packet342Summoning(IRCLinqed il, IRCThread thread, String command) {
		super(il, thread, command);
	}

	@Override
	public void handle() {
		addMessageToChat(MessageType.SERVER_INFO, "Summoning user " + getParam(1) + " to IRC");
	}
}
