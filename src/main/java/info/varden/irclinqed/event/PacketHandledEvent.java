...
public class PacketHandledEvent implements Event {
	private IRCPacket packet;
	
	public PacketHandledEvent(IRCPacket packet) {
		this.packet = packet;
	}
	...
	public void handle(EventHandler handler) {
		if (handler instanceof IPacketHandler) {
			((IPacketHandler) handler).onPacketHandled(this.packet.thread.getConnectionData(), this.packet);
		}
	}
