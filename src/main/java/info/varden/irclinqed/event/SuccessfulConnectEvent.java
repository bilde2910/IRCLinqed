...
public class SuccessfulConnectEvent implements Event {
	private ConnectionHelper data;
	
	public SuccessfulConnectEvent(ConnectionHelper data) {
		this.data = data;
	}
	...
	public void handle(EventHandler handler) {
		if (handler instanceof IConnectionHandler) {
			((IConnectionHandler) handler).onSuccessfulConnect(this.data);
		}
	}
