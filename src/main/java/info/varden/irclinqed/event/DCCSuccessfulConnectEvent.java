...
public class DCCSuccessfulConnectEvent implements Event {
	private DCCConnectionHelper data;
	
	public DCCSuccessfulConnectEvent(DCCConnectionHelper data) {
		this.data = data;
	}
	...
	public void handle(EventHandler handler) {
		if (handler instanceof IDCCConnectionHandler) {
			((IDCCConnectionHandler) handler).onDCCSuccessfulConnect(this.data);
		}
	}
